...
public class ByteUtils {
    ...
    public static byte[] fromBase58WithChecksum(String s) throws KeyValidationException {
        byte[] b = fromBase58(s);
        if (b.length < 4) {
            throw new KeyValidationException("Too short for checksum " + s);
        }
        byte[] cs = new byte[4];
        ...
        throw new KeyValidationException("Checksum mismatch " + s);
    }

    public static byte[] fromBase58(String s) throws KeyValidationException {
        try {
            ...
            throw new KeyValidationException("Invalid character in address");
        } catch (Exception e) {
