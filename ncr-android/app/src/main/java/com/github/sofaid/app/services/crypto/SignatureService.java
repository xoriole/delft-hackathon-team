...
public class SignatureService {
    ...
    public SignatureData signMessage(String hexMessage, String privateKey){
        byte[] message = Numeric.hexStringToByteArray(hexMessage);

        Credentials credentials  = Credentials.create(privateKey);
        return signMessage(message,credentials.getEcKeyPair());
    }

    public String signedMessageToKey(String hexMessage, SignatureData signatureData) throws SignatureException{
        byte[] message = Numeric.hexStringToByteArray(hexMessage);
        BigInteger publicKey = signedMessageToKey(message, signatureData);
    ...
    public static SignatureData signMessage(byte[] message, ECKeyPair keyPair) {
        ...
        /* NOTE: DON'T HASH MESSAGE INSIDE THIS METHOD; EXPECT ALREADY
        HASHED IN PARAMETER VALUE*/
    ...
    private static class ECDSASignature {
         ...
         * {@link SignatureService# HALF_CURVE_ORDER}. See
